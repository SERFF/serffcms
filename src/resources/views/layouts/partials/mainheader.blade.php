...
<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        ...
        <span class="logo-lg"><b>Kabola</b> CMS</span>
    </a>
                ...
                @else
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="https://placeholdit.imgix.net/~text?txtsize=33&txt=200%C3%97200&w=200&h=200" class="user-image" alt="User Image"/>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="https://placeholdit.imgix.net/~text?txtsize=33&txt=200%C3%97200&w=200&h=200" class="img-circle" alt="User Image" />
                                <p>
                                    {{ Auth::user()->name }}
                                </p>
                            </li>
